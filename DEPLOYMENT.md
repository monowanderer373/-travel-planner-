...
- **Redirect URL for production:** In Supabase dashboard go to **Authentication** → **URL Configuration**. Under **Redirect URLs**, add your live site URL so Google sign-in can return users there, e.g. `https://monowanderer373.github.io/-travel-planner-/`.
